...
# This CSS aims to precisely match your original input element's appearance
# while providing the necessary positioning for lifting and adding the terms text below.
st.markdown("""
<style>
    ...
    .main .st-emotion-cache-1gulkj5 {
         padding-bottom: 9rem; /* Adjust based on combined height, ~144px */
    }
    ...
    .custom-fixed-input-container button[data-testid="baseButton-secondary"] {
        padding: 0.5rem 0.75rem; /* Adjust padding to make it compact */
        line-height: 1; /* Helps vertically center the arrow */
        margin-left: 0.5rem; /* Small space between input and button */
        height: 38px; /* Match text input height roughly */
        border-radius: 7px; /* Keep rounded corners */
        /* Optionally, if you want it more like the native, remove background-color */
        background-color: transparent !important;
        color: #e6007e !important; /* Set color to pink */
        border: 1px solid #e6007e !important; /* Pink border */
    }
    /* Hide the Streamlit label for the custom text input, if it appears */
    .custom-fixed-input-container label {
